...
namespace MyOrderServices.Controllers
{
    public class ProductDetails1Controller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProductId,ProductName,ProductCategary,ProductCost,ProductImage,ManufacteringDate")] ProductDetail productDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductId,ProductName,ProductCategary,ProductCost,ProductImage,ManufacteringDate")] ProductDetail productDetail)
        {
            if (ModelState.IsValid)
            {
